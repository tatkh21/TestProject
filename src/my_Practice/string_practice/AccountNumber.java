...
public class AccountNumber {
    public static void main(String[] args) {
        String accountNumber = "5678940000";

        if (accountNumber.startsWith("2")){
            if (accountNumber.length() == 7) {
                System.out.println(accountNumber + " is a valid 7 digit account number");
            } else {
                System.out.println(accountNumber + " - Invalid account number");
            }
        } else if (accountNumber.startsWith("5")) {
            if (accountNumber.length() == 10) {
                System.out.println(accountNumber + " is a valid 10 digit account number");
            } else {
                System.out.println(accountNumber + " - Invalid account number");
            }
        } else {
